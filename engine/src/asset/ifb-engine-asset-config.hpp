...
namespace ifb::eng {
    ...
    // config nodes
    IFB_ENG_INTERNAL asset_config_asset_t*      asset_config_node_arena_alloc       (arena_t* arena);
    ...
    // config list
    IFB_ENG_INTERNAL asset_config_asset_list_t* asset_config_list_arena_alloc       (arena_t* arena, const u32 count = 1);
