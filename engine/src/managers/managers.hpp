...
namespace ifb::eng {
    ...
    IFB_ENG_INTERNAL void transform_lookup_translation    (transform_manager* const tm, translation*        out_translation, const transform_id* in_id,       const u32 in_count = 1);
    IFB_ENG_INTERNAL void transform_lookup_scale          (transform_manager* const tm, scale*              out_scale,       const transform_id* in_id,       const u32 in_count = 1);
    IFB_ENG_INTERNAL void transform_lookup_rotation       (transform_manager* const tm, rotation*           out_rotation,    const transform_id* in_id,       const u32 in_count = 1);
