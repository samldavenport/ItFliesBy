...
@set cl_eng_include= /Iengine\include /Iengine\src /Iengine\src\context /Iengine\src\core /Iengine\src\file /Iengine\src\gl /Iengine\src\memory /Iengine\src\asset /Iengine\src\devconsole /Iengine\src\os /Iengine\src\tools /Isld\include /Isld\external /Isld\vcpkg_installed\x64-windows\include
